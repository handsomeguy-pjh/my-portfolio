  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        title: "🛠 분석 접근 방식",
        content:
          "통계 분석을 머신러닝보다 먼저 수행했습니다. 통계 검정은 각 변수가 불량 발생과 유의미한 관계가 있는지 판단하는 근거를 제공하기 때문입니다. 머신러닝 모델에 무작위로 변수를 넣기 전에 chi-squared test, t-test, ANOVA로 유의미한 변수를 먼저 선별하면 모델 성능과 해석력이 높아집니다. 도메인 지식도 적극 활용했습니다. 통계적으로는 p-value > 0.05로 유의미하지 않았던 델타 페라이트 함량 변수를 특허 문헌(대한민국 특허청 제10-0397295호) 기반으로 6~8% 범위를 벗어날 경우 결함 발생 우려가 있다는 근거로 Vital Few에 포함시켰습니다.",
      },
      {
        title: "⚙️ 모델 선정 과정",
        content:
